  ...
  return (
    <div className="">
      <div className="flex rounded-xl dark:bg-darkmain w-full flex-col font-mono max-w-3xl container mx-auto p-7 mb-8">
        <h1 className=" text-center text-3xl">Jesse Leonard</h1>
        <div className="pt-5">
          ...
          and implementing new technologies that save my companies time and
          money. I strive to be the best engineer I can be and am working
          towards being certified as an AWS Solutions Architect.
        </div>
        ...
        <div className="pt-4">
          I work at a Veteran Owned Small Business that fulfills contracts for
        ...
        <ul className="list-disc list-inside ml-4">
          <li className="pt-3">
            ...
            forwarding network data between on premise and cloud infrastructure
            in python.
          </li>
          <li className="pt-3">
        ...
        <div className="pt-4">
          I worked at a small start working closely with the founder James
          Beedy. We worked on building automation tools that would deploy and
          cofigure High Performance Computers at scale with up to 100+ nodes.
        </div>
        <div className="pt-5">Duties Included:</div>
        <ul className="list-disc list-inside ml-4">
          <li className="pt-3">
          ...
          <li className="pt-3">
            Created CI/CD pipelines using Github Actions to effectively set up
            the environment, build the software, test, version, and release our
            products.
          </li>
          <li className="pt-3">
